# Install script for directory: /home/boubisto/ardupilot_gazebo
...
file(INSTALL DESTINATION "/usr/lib/x86_64-linux-gnu/gazebo-11/plugins" TYPE SHARED_LIBRARY FILES "/home/boubisto/ardupilot_gazebo/build/libArduCopterIRLockPlugin.so")
  if(EXISTS "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/gazebo-11/plugins/libArduCopterIRLockPlugin.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/gazebo-11/plugins/libArduCopterIRLockPlugin.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/gazebo-11/plugins/libArduCopterIRLockPlugin.so"
...
file(INSTALL DESTINATION "/usr/lib/x86_64-linux-gnu/gazebo-11/plugins" TYPE SHARED_LIBRARY FILES "/home/boubisto/ardupilot_gazebo/build/libArduPilotPlugin.so")
  if(EXISTS "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/gazebo-11/plugins/libArduPilotPlugin.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/gazebo-11/plugins/libArduPilotPlugin.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/lib/x86_64-linux-gnu/gazebo-11/plugins/libArduPilotPlugin.so"
...
file(INSTALL DESTINATION "/usr/share/gazebo-11/models/.." TYPE DIRECTORY FILES "/home/boubisto/ardupilot_gazebo/models")
endif()
...
file(INSTALL DESTINATION "/usr/share/gazebo-11/models/.." TYPE DIRECTORY FILES "/home/boubisto/ardupilot_gazebo/worlds")
endif()
...
file(WRITE "/home/boubisto/ardupilot_gazebo/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
